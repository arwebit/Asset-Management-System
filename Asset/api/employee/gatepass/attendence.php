...
if (($status_typeErr == "") && ($tokenErr == "")) {
    $credential[] = array("Createuser" => $create_user, "GatepassLinkID" => $gatepass_link_id, "Status" => $status,
        "Current_date" => $today_date_time);
    $updateStatus = $gatepassObj->gatepassAttendence(json_encode($credential));

<?php
$main_page = "Update task category";
$page = "Update task category";
...
if ($_SESSION['asset_member'] && $_SESSION['asset_token']) {
    ...
    if ($_REQUEST['category_id']) {
        ...
        if (isset($_REQUEST['save_category'])) {
            ...
            $updatecategory_getData = json_decode(callAPI($rp_data, $category_update_api));
        ...
        $getacategorysData = json_decode(callAPI($acategorys_recv_data, $selected_category_detail_api));

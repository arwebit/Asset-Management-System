    ...
    <html lang="en">
        ...
        <body onload="startTime()">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                $getausersData = json_decode(callAPI($agp_recv_data, $all_gatepass_details_api));
                                                    ...
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="font-weight: bolder;">Employee</th>
                                                            ...
                                                            foreach ($ret_agp_detail as $ret_agp_details) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger btn-rounded btn-sm" id="gp_delete" value="Delete"
                                                                                onclick="gatepass_delete('<?php echo $agp_id; ?>');">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                $getiusersData = json_decode(callAPI($igp_recv_data, $all_gatepass_details_api));
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                $getrusersData = json_decode(callAPI($rgp_recv_data, $all_gatepass_details_api));
            ...
            <script>
                ...
                function gatepass_delete(gatepass_id) {
                    var conf = confirm('Are you sure want to delete ?');
                    if(conf){
                    var login_user = "<?php echo $login_user; ?>";
                    var login_token = "<?php echo $login_token; ?>";
                    var values = [{session_token: login_token, session_user: login_user, gatepass_id: gatepass_id}];

                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url(); ?>/api/employee/gatepass/delete.php",
                        dataType: "json",
                        data: JSON.stringify(values),
                        success: function (RetVal) {
                            if (RetVal.message === "Success") {
                                $("#success_message").text(RetVal.data);
                                window.location.href = "view_all_gatepass.php";
                            } else {

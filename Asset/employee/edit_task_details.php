<?php
$main_page = "Update task details";
$page = "Update task details";
...
if ($_SESSION['asset_member'] && $_SESSION['asset_token']) {
    ...
    $update_task_detail_error = false;
    if ($_REQUEST['task_detail_id']) {
        $task_detail_id = $_REQUEST['task_detail_id'];
        if (isset($_REQUEST['update_task_details'])) {
            ...
            $create_task_detail_data[] = array("session_token" => $login_token, "session_user" => $login_user, "task_detail_id" => $task_detail_id,
            ...
            $create_task_detail_getData = json_decode(callAPI($cr_data, $task_detail_update_api));
            $update_task_detail_error = $create_task_detail_getData->error;
        ...
        if ($ret_atasks_error == true) {
            ...
            foreach ($ret_atasks_detail as $ret_atasks_details) {
                ...
                $femp_remarks = $ret_atasks_details->emp_remarks;
                                                ...
                                                <form class="forms-sample" action="" method="post">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="supervisor_name" id="supervisor_name">
                                                                    ...
                                                                    <?php
                                                                    if ($update_task_detail_error == false) {
                                                                        if ($fcheck_supervisor == "") {
                                                                            echo "selected='selected'";
                                                                        }
                                                                    } else {
                                                                        if ($check_supervisor == "") {
                                                                    ...
                                                                    ?>>SELECT SUPERVISOR</option>
                                                                            ...
                                                                            <?php
                                                                            if ($update_task_detail_error == false) {
                                                                                if ($fcheck_supervisor == $user_name) {
                                                                                    echo "selected='selected'";
                                                                                }
                                                                            } else {
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <button type="submit" name="update_task_details" id="update_task_details" class="btn btn-primary mr-2">Save</button>

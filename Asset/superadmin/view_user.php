                        ...
                        <div class="content-wrapper">
                            <div class="row">
                                                    ...
                                                    <table class="table table-hover sampleTable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($ret_ausers_detail as $ret_ausers_details) {
                                                                $ausers_emp_code = $ret_ausers_details->emp_code;
                                                                ...
                                                                ?>
                                                                <tr>
                                                                    <td><a href="view_admin_records.php?admin_id=<?php echo $ausers_username; ?>&&admin_name=<?php echo $amem_name; ?>"><?php echo $amem_name; ?></a></td>
                                                                    <td><?php echo $ausers_name; ?></td>
                                                                    <td><?php echo $ausers_emp_code; ?></td>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Inactive admins</h4>
                                            <div class="table-responsive">
                                                <?php
                                                    ...
                                                    <table class="table table-hover sampleTable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($ret_iusers_detail as $ret_iusers_details) {
                                                                $islno++;
                                                                $iusers_emp_code = $ret_iusers_details->emp_code;
                                                                $iusers_name = $ret_iusers_details->username;
                                                                $iusers_password = encrypt_decrypt('decrypt', $ret_iusers_details->password);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $iusers_emp_code; ?></td>
                                                                    <td><?php echo $iusers_password; ?></td>

<?php
$main_page = "View task category";
$page = "View task category";
        ...
        <body onload="startTime()">
                        ...
                        <div class="content-wrapper">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Active task categories</h4>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($ret_acategorys_detail as $ret_acategorys_details) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <a href="edit_task_category.php?category_id=<?php echo $acategorys_id; ?>">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Inactive task catgegories</h4>
                                            <div class="table-responsive">
                                                ...
                                                $geticategorysData = json_decode(callAPI($icategorys_recv_data, $category_details_api));
            ...
            <script type="text/javascript">
                ...
                function change_status(category_status, category_id) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url(); ?>/api/common/task_category/availability.php",
                        dataType: "json",
                        data: JSON.stringify(values),
                        success: function (RetVal) {
                            if (RetVal.message === "Success") {
                                $("#success_message").text(RetVal.data);
                                window.location.href = "view_task_category.php";
                            } else {
